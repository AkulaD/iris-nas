        ...
        <div class="placeholder-container-box border border-dashed rounded d-flex align-items-center justify-content-center p-5 mt-3">
            <div class="text-center py-5">
                <div class="icon-cloud-display-wrapper mb-3 mx-auto">
                    <i class="bi bi-clock-history text-muted opacity-50 display-4"></i>
                </div>
                <h6 class="fw-medium text-dark mb-1">Belum ada aktivitas terbaru</h6>
                <p class="text-muted small mx-auto max-width-p">File dan folder yang baru saja Anda buat, upload, atau modifikasi akan muncul di sini.</p>
            </div>
        </div>
    <?php else: ?>
        <?php 
